...
#define GLX_NV_swap_group 1
  ...
  Bool glXQuerymax_SwapGroupsNV (Display *dpy, int screen, GLuint *maxGroups, GLuint *maxBarriers);
...
#define GLX_SGIX_swap_barrier 1
  ...
  Bool glXQuerymax_SwapBarriersSGIX (Display *dpy, int screen, int *max);
#endif
